...
#pragma region getFacings
#pragma region declarations
	static void rotate(putils::Point3f & dst, const putils::Point3f & axis, float angle);
#pragma endregion
...
#pragma region declarations
	static void axisToQuaternion(float * quat, const putils::Point3f & axis, float angle);

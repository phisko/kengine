...
public:
	...
	/// inside with b2::World::DrawDebugData method. The debug draw object is owned
	...
	/// Get the world body list. With the returned body, use b2::Body::GetNext to get
	/// the next body in the world list. A NULL body indicates the end of the list.
	/// @return the head of the world body list.
	Body* GetBodyList();
	const Body* GetBodyList() const;

	/// Get the world joint list. With the returned joint, use b2::Joint::GetNext to get
	/// the next joint in the world list. A NULL joint indicates the end of the list.
	/// @return the head of the world joint list.
	Joint* GetJointList();
	const Joint* GetJointList() const;

	/// Get the world contact list. With the returned contact, use b2::Contact::GetNext to get
	/// the next contact in the world list. A NULL contact indicates the end of the list.
	/// @return the head of the world contact list.
	/// @warning contacts are created and destroyed in the middle of a time step.
	/// Use b2::ContactListener to avoid missing contacts.

...
/// Input parameters for b2::TimeOfImpact
struct TOIInput
{
...
// Output parameters for b2::TimeOfImpact.
struct TOIOutput
{
	enum State
	{
...
/// again.
/// Note: use b2::Distance to compute the contact point and normal at the time of impact.

...
TEST_F(EntityManagerTest, RegisterGameObject) {
    struct S : kengine::System<S, kengine::packets::RegisterGameObject> {
        S(std::string & msg) : msg(msg) {}
        void handle(const kengine::packets::RegisterGameObject & p) { msg = p.go.getName(); }
        std::string & msg;
    };
    std::string msg;
    em.createSystem<S>(msg);
...
TEST_F(EntityManagerTest, RemoveGameObject) {
    struct S : kengine::System<S, kengine::packets::RemoveGameObject> {
        S(std::string & msg) : msg(msg) {}
        void handle(const kengine::packets::RemoveGameObject & p) { msg = p.go.getName(); }
        std::string & msg;
    };
    std::string msg;
    em.createSystem<S>(msg);
...
TEST_F(EntityManagerTest, RemoveSystem) {
    struct S : kengine::System<S> {
        S(kengine::EntityManager & em) : _em(em) {}
        kengine::EntityManager & _em;
    };
